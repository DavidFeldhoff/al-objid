 ...
 */
export class LostFieldObjectTypeGroupNode extends AppsAwareDescendantNode {
    ...
    constructor(parent: AppsAwareNode, assigned: AssignedALObject[]) {
        super(parent);
